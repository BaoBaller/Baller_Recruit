  ...
  return (
    <AdminLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-foreground" data-testid="text-hero-page-title">
            {t.admin.heroEditor}
          </h1>
          <p className="text-muted-foreground mt-1">
            Manage the hero section displayed on the landing page.
          </p>
        </div>
        ...
        <Card className="border-card-border">
          <CardHeader>
            ...
            <CardDescription>
              Configure the headline, subtitle, and call-to-action for both languages.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.subtitleVi && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.subtitleVi.message}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.subtitleEn && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.subtitleEn.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) =>
                      form.setValue("backgroundType", value as "image" | "video")
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.ctaTextVi && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.ctaTextVi.message}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.ctaTextEn && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.ctaTextEn.message}
                      </p>
                    )}
                  </div>
                </div>
