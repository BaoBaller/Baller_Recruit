...
const jobSchema = z.object({
  ...
  departmentEn: z.string().min(1, "Department (English) is required"),
  ...
  salaryEn: z.string().min(1, "Salary (English) is required"),
  ...
  requirementsVi: z.string().min(1, "Requirements (Vietnamese) is required"),
  requirementsEn: z.string().min(1, "Requirements (English) is required"),
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground" data-testid="text-job-form-title">
        ...
        <Card className="border-card-border">
          <CardHeader>
            ...
            <CardDescription>
              Enter the job information in both Vietnamese and English.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading && isEditing ? (
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.jobTitleVi && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.jobTitleVi.message}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.jobTitleEn && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.jobTitleEn.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.departmentVi && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.departmentVi.message}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.departmentEn && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.departmentEn.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.locationVi && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.locationVi.message}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.salaryVi && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.salaryVi.message}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.salaryEn && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.salaryEn.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.requirementsVi && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.requirementsVi.message}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.requirementsEn && (
                      <p className="text-sm text-destructive">
                        {form.formState.errors.requirementsEn.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {form.formState.errors.applyEmail && (
                      <p className="text-sm text-destructive">
                ...
                <div className="flex items-center gap-3 p-4 rounded-lg border bg-muted/30">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      When active, this job will be visible on the public website.
                    </p>
                  </div>
                </div>
